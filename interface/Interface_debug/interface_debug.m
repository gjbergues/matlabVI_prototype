...
%                 if strcmp(get(handles.Ton, 'string'), 'OFF')
%                     fprintf(handles.s, 'MEAS? 1');
%                     Tprov = str2double(fscanf(handles.s));  
%                     Ba = isnan(Tprov);
%                     if ~Ba && Tprov > 19             
%                         Tv(1) = Tprov;
%                     elseif ~Ba && Tprov < 19 
...
%                     end             
%                     
%                     fprintf(handles.s, 'MEAS? 3');
%                     Dprov = str2double(fscanf(handles.s)); 
%                     Ba = isnan(Dprov);
%                     if ~Ba && Dprov < 10             
%                         Dv(1) = Dprov;
%                     elseif ~Ba && Dprov > 10 
...
%                     end
%                     
%                     set(handles.Temp, 'string', num2str(Tv(1), 4));   
%                     set(handles.Deriva, 'string', num2str(Dv(1), 3));   
%                 end
  ...
  %%%%%%%%%%%%%%%%%%%%% MEDICIÓN EN SERIE%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
        ...
        elseif (get(handles.nom, 'string') == '0')     
            ...
            while (dim - i) ~= 0 %Establece cantidad de mediciones
                ...
                set(handles.Deriva, 'string', Dv(i)); 
                set(handles.Temp, 'string', Tv(i));
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
