...
for i=1:NI
f=['/media/B/Doctorado/Fotos Autocolimador/Diagonal apunta escritorio 4/pos 1/cruz 1/Image-' num2str(i) '.bmp'];
...
imwrite(uint8(SumaTotal/NI-2),'/media/B/Doctorado/Fotos Autocolimador/Diagonal apunta escritorio 4/pos 1/imprueba.png')
